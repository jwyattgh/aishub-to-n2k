...
function normalize (r) {
  ...
  return {
    ...
    eta: cleanText(r.ETA),
    // An IMO number means a ship that must carry a class A transponder;
    // everything else is treated as class B. Same rule as signalk-aishub-ws.
    class: imo >= 1000000 && imo <= 9999999 ? 'A' : 'B'
  }
}
